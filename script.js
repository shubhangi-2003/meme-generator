...
function clearAll() {
    ...
    const puzzle = document.querySelector(".puzzle-content");
  ...
  */
  function showRiddle() {
    ...
    const riddleContainer = document.querySelector('.puzzle-content');
    ...
    riddleContainer.appendChild(newQuestion);
  ...
  */
  function revealAnswers() {
    const riddleContent = document.querySelector('.puzzle-content');
